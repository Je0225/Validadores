...
namespace Validadores.CalculosDvs {
  internal class CalculoDigitosVerificadoresCnpj : ICalculoDigitosVerificadores{
    ...
    private Int32 CalculaDv(String documento, Int32 indexDv, Int32[] pesos) {
      ...
      for (Int32 i = 0; i < documento.Length - indexDv; i++) {
        Int32 numero = Char.IsLetter(documento[i]) ? Convert.ToInt32(documento[i]) - 48 : Convert.ToInt32(documento[i].ToString());
